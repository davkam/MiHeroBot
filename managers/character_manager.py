...
class CharacterManager():
    ...
    async def new_player_manager(self):
        ...
        new_player_file = discord.File(fp=CharacterManager.NEW_PLAYER_PATH % "1")
        ...
        while not await new_player_view.wait():
            ...
            new_player_file = discord.File(fp=CharacterManager.NEW_PLAYER_PATH % f"{new_player_view.character}")
        ...
        if new_player_view.selected:
            ...
            player_stats_path = await renderer.render_stats()
            ...
            await TempImageHandler.del_temp_image(path=player_stats_path)
