...
# on_ready(): Event listener for "on_ready", runs when client is ready and connected.
@bot.client.event
async def on_ready():
    await bot.ready_respond()

# on_message(): Event listener for "on_message", runs when message is created in discord channel.
@bot.client.event
